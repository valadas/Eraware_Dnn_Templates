...
export default function alertError(reason: ErrorReason): void {
  ...
  if (
    ...
    reason !== null &&
    "ModelState" in reason &&
    reason.ModelState !== undefined &&
    reason.ModelState !== null &&
    typeof reason.ModelState === "object"
  ) {
  ...
  if ("isApiException" in reason && reason.isApiException === true && "response" in reason) {
    try {
